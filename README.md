> **نسخهٔ نهایی ۲.۲.۲۳:** [ضد بن تلگرام — خروج یک‌هفته‌ای یکی‌یکی + قفل ۲۰ دقیقه‌ای بعد از لغو سفارش](docs/ANTIBAN_2.2.23_FA.md)
> **نسخهٔ ۲.۲.۲۲:** [تعداد اکانت هیچ مشکلی نیست — بدون پیام خطا، اجرای کامل تا پایان زمان، هزینه فقط زمانی](docs/NO_COUNT_PROBLEM_2.2.22_FA.md)
> **نسخهٔ ۲.۲.۲۱:** [استخر کوچک‌تر از سفارش مشکلی نیست — سفارش با همان اکانت‌ها تا پایان زمان کامل اجرا می‌شود و هزینه فقط زمانی است](docs/SMALLER_POOL_2.2.21_FA.md)
