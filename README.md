> **نسخهٔ نهایی ۲.۲.۲۱:** [استخر کوچک‌تر از سفارش مشکلی نیست — سفارش با همان اکانت‌ها تا پایان زمان کامل اجرا می‌شود و هزینه فقط زمانی است](docs/SMALLER_POOL_2.2.21_FA.md)
