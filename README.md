...
| [`docs/full-version.fa.md`](docs/full-version.fa.md) | موجودی قابلیت‌های کد ۲.۳.۱۷ و محدودیت‌های بررسی آفلاین |
| [`docs/env-compatibility.fa.md`](docs/env-compatibility.fa.md) | **گارد نام/مقدار تنظیمات تاریخی `.env`؛ پیش از استقرار بخوانید** |
| [`docs/deploy-final.fa.md`](docs/deploy-final.fa.md) | **دستورهای استقرار مشروط نسخهٔ ۲.۳.۱۷ روی نصب موجود**؛ قرنطینهٔ خصوصی فایل‌های ناشناس و ممیزی پرداخت‌های pending پیش از Docker |
...
# نسخهٔ ۲.۳.۱۷ تنظیمات تاریخی شناخته‌شده را با گارد نام/مقدار بررسی می‌کند.
...
- `main` هنوز روی ۲.۲.۳ است. کد شاخهٔ `arena/01a0ccf5-tgcallbot` نسخهٔ ۲.۳.۱۷ است؛ تغییر شاخه یا ادغام GitHub، **سرور را خودکار به‌روز نمی‌کند** و تست آفلاین سلامت سشن/تماس زنده را ثابت نمی‌کند.
