...
# کلید تکراری در .env یک باگِ بی‌صداست: dotenv آخرین مقدار را نگه می‌دارد،
# پس اگر یک اسکریپت مقدار تازه را به انتهای فایل «اضافه» کند (به‌جای جایگزین
# کردن)، هر دو تعریف سر جایشان می‌مانند و حذفِ بعدیِ یکی از آن‌ها مقدار را
# بی‌صدا به حالت قبل برمی‌گرداند. این بررسی در استارتاپ هشدار می‌دهد.
